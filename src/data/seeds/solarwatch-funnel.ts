...
export const solarwatchFunnelNodes: Node[] = [
  ...
  { id: 'ad-linkedin-retarget', type: 'touchpoint', position: { x: 0, y: 150 }, data: {
    ...
    asset: { contentType: 'ad', content: {
      ...
      primaryText: '📊 ראינו שביקרת ב-SolarWatch אבל לא השארת פרטים.\n\nאחד הלקוחות שלנו — חברת בנייה עם 12 פרויקטים פעילים — חסך 18 שעות עבודה שבועיות לאחר ההטמעה.\n\nהצע לך 30 דקות הדגמה פרסונלית בלי עלות ובלי לחץ.\n\n📅 בחר זמן שמתאים לך →',
      callToAction: 'קבע הדגמה',
      destinationUrl: 'solarwatch.vercel.app/demo',
      imagePrompt: 'Side-by-side comparison: chaos of paper documents vs clean SolarWatch dashboard',
    }},
  }},
  { id: 'ad-google', type: 'touchpoint', position: { x: 0, y: 300 }, data: {
    label: 'Google Ads — "פיקוח סולארי" / "ניהול שותפים"', type: 'ad',
    url: 'https://ads.google.com',
    asset: { contentType: 'ad', content: {
      platform: 'google',
      headline: 'פיקוח סולארי מלא | SolarWatch | הדגמה חינמית',
      primaryText: 'פלטפורמת פיקוח ייחודית לחברות בנייה ומפקחי פרויקטים סולאריים. ניהול ציות, עמידה בלוחות זמנים ושקיפות מלאה על ביצועי שותפים.',
  ...
  { id: 'ad-industry', type: 'touchpoint', position: { x: 0, y: 450 }, data: {
    ...
    asset: { contentType: 'ad', content: {
      ...
      primaryText: 'תקנות האנרגיה המתחדשת הפכו את הציות לעסק מורכב.\n\nSolarWatch הוא הפתרון המוביל לחברות בנייה ישראליות: ניהול שותפים, מעקב ציות, דוחות אוטומטיים — בעברית מלאה.\n\n🏆 130+ פרויקטים מנוהלים | ₪12M חיסכון מוכח ללקוחותינו\n\nלפרטים: solarwatch.vercel.app',
  ...
  { id: 'lp-main', type: 'touchpoint', position: { x: 450, y: 150 }, data: {
    label: 'דף הבית — SolarWatch', type: 'page',
    url: 'https://solarwatch.vercel.app',
    asset: { contentType: 'landing', content: {
      hero: {
        headline: 'פיקוח מלא על שותפי הסולאר שלך — בזמן אמת',
        subheadline: 'SolarWatch מאגד ניהול שותפים, מעקב ציות ולוחות בקרה חיים לחברות בנייה ישראליות עם 3+ פרויקטים סולאריים פעילים.',
        ctaText: 'בקש הדגמה מותאמת →',
        ctaUrl: 'https://solarwatch.vercel.app/demo',
      },
      benefits: [
        { icon: '👁️', title: 'שקיפות מלאה', description: 'ראה את מצב כל שותף, כל אתר, כל מסמך — בלחיצה אחת' },
      ...
      socialProof: [
        { quote: 'לפני SolarWatch הייתי מבלה 4 שעות בשבוע על בדיקת אקסל. היום לוח הבקרה אומר לי בדיוק מה קורה בכל אתר.', author: 'דני כהן', role: 'מנהל פרויקטים, חברת בנייה ישראלית — 8 פרויקטים סולאריים' },
  ...
  { id: 'lp-compliance', type: 'touchpoint', position: { x: 450, y: 300 }, data: {
    ...
    asset: { contentType: 'landing', content: {
      hero: {
        ...
        subheadline: 'SolarWatch מסייע לחברות בנייה לעמוד בכל דרישות הציות של רשות החשמל, תקנות הבנייה והתקנים הישראליים — אוטומטית.',
        ctaText: 'קבל ביקורת ציות חינמית →',
        ctaUrl: 'https://solarwatch.vercel.app/compliance-audit',
      },
      benefits: [
      ...
      faq: [
        ...
        { q: 'מה קורה כשמסמך עומד לפוג?', a: 'המערכת שולחת התראה אוטומטית למנהל האחראי ולשותף ב-30, 14 ו-7 ימים לפני הפקיעה.' },
      ],
    }},
  }},
  { id: 'lp-demo', type: 'touchpoint', position: { x: 450, y: 450 }, data: {
    ...
    asset: { contentType: 'landing', content: {
      hero: {
        headline: 'ראה איך SolarWatch עובד — עם הנתונים שלך',
        ...
        ctaUrl: 'https://solarwatch.vercel.app/book-demo',
      },
      benefits: [
  ...
  { id: 'lm-guide', type: 'touchpoint', position: { x: 850, y: 300 }, data: {
    ...
    asset: { contentType: 'leadMagnet', content: {
      ...
      description: 'המדריך המקיף לחברות בנייה ישראליות: תקנות עדכניות, תהליכי ציות, ניהול שותפים ומדדי ביצוע — הכל בעברית.',
      format: 'pdf',
      ...
      previewPoints: [
        ...
        'מדדי KPI מומלצים לפיקוח על שותפים',
  ...
  { id: 'lm-platform-demo', type: 'touchpoint', position: { x: 850, y: 450 }, data: {
    ...
    url: 'https://solarwatch.vercel.app',
    asset: { contentType: 'form', content: {
      title: 'גישה לסביבת הדמו — נסה את SolarWatch',
      description: 'הגדר פרויקט לדוגמה, נהל שותפים וראה את לוחות הבקרה — בסביבה מוגנת ללא סיכון.',
      fields: [
        { name: 'name', label: 'שם מלא', type: 'text', required: true },
        { name: 'email', label: 'אימייל עסקי', type: 'email', required: true },
        { name: 'company', label: 'שם החברה', type: 'text', required: true },
        { name: 'project_count', label: 'כמה פרויקטים אתה מנהל?', type: 'select', required: true, options: ['1-3', '4-7', '8-15', '15+'] },
        { name: 'use_case', label: 'מה הדבר הכי חשוב שאתה רוצה לראות?', type: 'select', options: ['ניהול מסמכי ציות', 'מעקב שותפים', 'לוחות בקרה ודוחות', 'התראות ועדכוני סטטוס', 'הכל'] },
      ],
  ...
  { id: 'email-intro', type: 'touchpoint', position: { x: 1250, y: 150 }, data: {
    ...
    asset: { contentType: 'email', content: {
      subject: 'ברוכים הבאים ל-SolarWatch — הנה מה שהפלטפורמה עושה בשבילך',
      preheader: 'פיקוח מלא על שותפי הסולאר שלך — מהיום',
      sendDay: 0,
      body: '<p>שלום [שם],</p><p>תודה שהצטרפת — אנחנו שמחים שאתה כאן.</p><p>SolarWatch נבנה במיוחד עבור חברות בנייה ישראליות שמנהלות פרויקטים סולאריים עם שותפים — וסובלות מחוסר שקיפות, בעיות ציות ועיכובים שאפשר היה למנוע.</p><h3>מה הפלטפורמה עושה בשבילך:</h3><ul><li>📊 <strong>לוח בקרה מרכזי:</strong> מצב כל פרויקט וכל שותף בזמן אמת</li><li>✅ <strong>ניהול ציות אוטומטי:</strong> מעקב אחר כל האישורים ומסמכי הבטיחות</li><li>🚨 <strong>התראות חכמות:</strong> קבל עדכון לפני שעיכוב הופך לבעיה</li><li>📋 <strong>דוחות בלחיצה:</strong> PDF מקצועי ללקוחות ולביקורות חיצוניות</li></ul><p>בשבוע הקרוב נשלח לך מידע שיעזור לך להבין אם SolarWatch מתאים לפורטפוליו שלך.</p>',
      ctaText: 'גלה את לוח הבקרה →',
      ctaUrl: 'https://solarwatch.vercel.app',
    }},
  }},
  { id: 'email-casestudy', type: 'touchpoint', position: { x: 1250, y: 280 }, data: {
    label: 'יום 5: סטאדי קייס — חברת בנייה ישראלית', type: 'email',
    asset: { contentType: 'email', content: {
      subject: 'איך חברת בנייה חסכה 22 שעות עבודה בשבוע עם SolarWatch',
      preheader: 'מקרה אמיתי: 9 פרויקטים סולאריים, שותף מחוץ לציות, ₪85,000 חיסכון',
      sendDay: 5,
      body: '<p>שלום [שם],</p><p>תן לי לספר לך על לקוח שלנו — חברת בנייה בינונית עם 9 פרויקטים סולאריים פעילים.</p><h3>🏗️ לפני SolarWatch:</h3><ul><li>מנהל הפרויקטים בילה 22 שעות שבועיות בבדיקת אקסל ו-WhatsApp</li><li>שותף אחד עבד ללא אישור בטיחות מעודכן — ונתגלה רק בביקורת</li><li>עיכוב של 3 שבועות בפרויקט אחד בגלל מסמך חסר</li><li>קנס של ₪35,000 מרשות החשמל</li></ul><h3>✅ אחרי SolarWatch (6 חודשים):</h3><ul><li><strong>22 שעות → 4 שעות:</strong> חיסכון של 18 שעות עבודה שבועיות</li><li><strong>0 אירועי ציות:</strong> כל המסמכים מעודכנים אוטומטית</li><li><strong>לוחות זמנים:</strong> הפרויקטים הוגשו בזמן ב-3 חודשים רצופים</li><li><strong>ROI:</strong> החיסכון כיסה את עלות הפלטפורמה תוך 6 שבועות</li></ul><p>האם הפורטפוליו שלך נראה דומה? בוא נבדוק יחד.</p>',
      ctaText: 'קבע שיחה של 15 דקות →',
      ctaUrl: 'https://solarwatch.vercel.app/book',
    }},
  }},
  { id: 'email-roi', type: 'touchpoint', position: { x: 1250, y: 410 }, data: {
    ...
    asset: { contentType: 'email', content: {
      ...
      preheader: 'ROI של SolarWatch — מספרים אמיתיים לפורטפוליו שלך',
      sendDay: 14,
      body: '<p>שלום [שם],</p><p>בוא נדבר מספרים — כי בסופו של דבר, זה מה שמנהלים מקבלים החלטות לפיו.</p><h3>📊 חישוב ROI טיפוסי לחברת בנייה עם 5 פרויקטים:</h3><table><tr><td><strong>עלות ניהול פיקוח ידני</strong></td><td>₪8,500/חודש</td></tr><tr><td>שעות עבודה (×₪150/שעה × 12 שעות/שבוע)</td><td>₪7,200/חודש</td></tr><tr><td>עלות ממוצעת של אירוע ציות לא מזוהה</td><td>₪15,000-₪45,000/שנה</td></tr><tr><td><strong>עלות SolarWatch (5 פרויקטים)</strong></td><td>₪2,500/חודש</td></tr><tr><td><strong>חיסכון חודשי נטו</strong></td><td><strong>₪6,000-₪8,000</strong></td></tr></table><p>חברות שמשתמשות ב-SolarWatch מדווחות על <strong>תקופת החזר של 6-10 שבועות</strong>.</p><p>רוצה לחשב את ה-ROI הספציפי לפורטפוליו שלך? נעשה את זה ביחד בשיחה קצרה.</p>',
      ctaText: 'חשב את ה-ROI שלי →',
      ctaUrl: 'https://solarwatch.vercel.app/roi-calculator',
    }},
  }},
  ...
  { id: 'email-proposal', type: 'touchpoint', position: { x: 1250, y: 670 }, data: {
    ...
    asset: { contentType: 'email', content: {
      ...
      ctaUrl: 'https://solarwatch.vercel.app/proposal/[id]',
    }},
  }},
  ...
  { id: 'tp-onsite-demo', type: 'touchpoint', position: { x: 1650, y: 150 }, data: {
    ...
    asset: { contentType: 'landing', content: {
      hero: {
        ...
        subheadline: 'נגיע אליכם עם לפטופ ונדגים את SolarWatch על פרויקט אמיתי מהפורטפוליו שלכם. ללא פרזנטציה מוכנה מראש — רק מה שרלוונטי לחברה שלכם.',
        ctaText: 'תאם הדגמה בשטח →',
        ctaUrl: 'https://solarwatch.vercel.app/book-onsite',
      },
      benefits: [
  ...
  { id: 'tp-proposal-doc', type: 'touchpoint', position: { x: 1650, y: 300 }, data: {
    ...
    asset: { contentType: 'landing', content: {
      ...
      benefits: [
        { icon: '📐', title: 'ניתוח פורטפוליו', description: 'מיפוי מלא של הפרויקטים, השותפים ותהליכי העבודה הנוכחיים' },
  ...
  { id: 'tp-pilot', type: 'touchpoint', position: { x: 1650, y: 450 }, data: {
    ...
    url: 'https://solarwatch.vercel.app',
    asset: { contentType: 'form', content: {
      title: 'הצטרפות לפיילוט SolarWatch — 30 יום ללא עלות',
      ...
      fields: [
        ...
        { name: 'contractor_count', label: 'מספר שותפים בפרויקט', type: 'select', options: ['1-2', '3-5', '6-10', '10+'] },
      ...
      successMessage: 'מצוין! נציג SolarWatch יצור איתך קשר תוך 4 שעות לתיאום תחילת הפיילוט.',
    }},
  }},
  ...
  { id: 'tp-contract', type: 'touchpoint', position: { x: 2050, y: 150 }, data: {
    ...
    asset: { contentType: 'landing', content: {
      hero: {
        headline: 'ברוכים הבאים ל-SolarWatch — חתמו על החוזה השנתי',
  ...
  { id: 'tp-onboard', type: 'touchpoint', position: { x: 2050, y: 450 }, data: {
    ...
    asset: { contentType: 'landing', content: {
      hero: {
        ...
        ctaUrl: 'https://solarwatch.vercel.app/dashboard',
      },
      benefits: [
        { icon: '⚙️', title: 'הגדרת מערכת (יום 1-3)', description: 'ייבוא פרויקטים, הגדרת שותפים ומסמכי ציות ראשוניים' },
        { icon: '🎓', title: 'הכשרת צוות (יום 4-7)', description: 'סשן הדרכה של 2 שעות לכל מנהל רלוונטי' },
        { icon: '🚀', title: 'פרויקט ראשון חי (יום 8-14)', description: 'ניהול פרויקט ראשון בפיקוח מלא של צוות SolarWatch' },
...
export const solarwatchFunnelEdges: Edge[] = [
  // Ads → Landing Pages
