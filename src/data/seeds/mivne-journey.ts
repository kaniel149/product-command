...
export const mivneJourneyNodes: Node[] = [
  // Personas (top row)
  { id: 'p1', type: 'persona', position: { x: 0, y: 0 }, data: {
    ...
    painPoints: ['קושי לעקוב אחר מספר קבלנים במקביל', 'תיעוד ידני מביא לטעויות ועיכובים', 'קשה להוכיח עמידה בתקנות מול רשויות'],
  ...
  { id: 'p3', type: 'persona', position: { x: 0, y: 400 }, data: {
    name: 'קבלן ראשי', demographics: 'מנהל 3-8 קבלני משנה, אחראי על לוח זמנים ותקציב, עובד עם מספר פרויקטים בו-זמנית',
    painPoints: ['קשה לתאם בין קבלני משנה סולאריים', 'עיכובים גורמים לקנסות חוזיים', 'ניהול מסמכים מפוזר בין WhatsApp ואימייל'],
    channels: ['WhatsApp', 'הפניות קולגות', 'כנסי קבלנים'], color: '#f97316',
  }},
  ...
  { id: 'm1', type: 'message', position: { x: 350, y: 730 }, data: {
    content: 'פיקוח על קבלני סולאר — הכל במקום אחד. מסמכים, לוחות זמנים, עמידה בתקנות.',
    language: 'HE',
  }},

  // עניין — Interest
  { id: 's2', type: 'stage', position: { x: 700, y: 100 }, data: { label: 'עניין', funnelStage: '2', description: 'חקירה ראשונית של הפתרון' } },
  { id: 't4', type: 'touchpoint', position: { x: 700, y: 280 }, data: { label: 'דמו פלטפורמה (מודרך)', type: 'page', url: 'https://mivne-crm.vercel.app' } },
  ...
  { id: 't7', type: 'touchpoint', position: { x: 1050, y: 480 }, data: { label: 'ביקורת ציות חינמית', type: 'form', url: 'https://mivne-crm.vercel.app' } },
  ...
  { id: 't11', type: 'touchpoint', position: { x: 1750, y: 280 }, data: { label: 'Onboarding + הדרכה בפלטפורמה', type: 'page', url: 'https://mivne-crm.vercel.app' } },
...
export const mivneJourneyEdges: Edge[] = [
  // Personas → Awareness
